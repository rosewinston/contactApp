...
public:
    ...
    void addEntry(string first,string last,string phone,string email,string timezone,string type);
    void editEntry(string idnum,string first,string last,string phone,string email,string timezone,string type);
